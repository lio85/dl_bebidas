...
fetch("https://dl-bebidas-dashboard.herokuapp.com/api/productsbycategory")
    ...
    .then(function(data_decode){
        ...
        order(aperitivos.listItems);
        order(cervezas.listItems);
        order(gaseosas.listItems);
        order(vinos.listItems);
        order(whiskeys.listItems);
